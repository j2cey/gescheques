...
/* harmony import */ var _ExecBus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ExecBus */ "./resources/js/views/workflowexecs/ExecBus.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    /*$props: {
        handler() {
            this.parseData(); // anytime any props would change, I needed to parse my data again
        },
  ...
  mounted: function mounted() {
    ...
    _ExecBus__WEBPACK_IMPORTED_MODULE_2__["default"].$on('step_process', function (processdata) {
  ...
  methods: {
    parseData: function parseData(wfexec, currentstep, nextstep, actions, actionvalues, enumvalues) {
      ...
      this.nextstep = nextstep[this.treatment_type];
      this.actions = actions[this.treatment_type]; //let actionvalues_typed = actionvalues[this.treatment_type]

      this.actionvalues = actionvalues[this.treatment_type];
      this.enumvalues = enumvalues;
      this.wfexecForm = new Form(actionvalues[this.treatment_type]);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (_this3.treatment_type === "rejection") {
                  _this3.$swal({
    ...
    submitForm: function submitForm(execId) {
      ...
      this.wfexecForm.put("/workflowexecs/".concat(execId), fd).then(function (data) {
        ...
        _this4.$swal({
          html: '<small>Traitement Effectif !</small>',
          icon: 'success',
          timer: 3000
        }).then(function () {
          _ExecBus__WEBPACK_IMPORTED_MODULE_2__["default"].$emit('step_processed', data);
        });
