...
/* harmony import */ var _cheques_chequeBus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../cheques/chequeBus */ "./resources/js/views/cheques/chequeBus.js");
  ...
  methods: {
    ...
    addFileToForm: function addFileToForm() {
      if (typeof this.selectedFile !== 'undefined') {
        var fd = new FormData();
        fd.append('step_files', this.selectedFile); //console.log("image added", fd);
