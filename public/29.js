...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios.get('/enumtypes.fetch').then(function (_ref6) {
      var data = _ref6.data;
      return _this2.enumtypes = data;
    });
  },
  data: function data() {
    return {
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "card-body" }, [
                  ...
                  _vm._v(" "),
                  _vm.workflowactionForm.actiontype.code === "EnumType"
                    ? _c("div", { staticClass: "form-group row" }, [
                        ...
                        _c(
                          ...
                          [
                            _c("multiselect", {
                              ...
                              model: {
                                value: _vm.workflowactionForm.enumtype,
                                callback: function($$v) {
                                  _vm.$set(
                                    _vm.workflowactionForm,
                                    "enumtype",
                                ...
                                expression: "workflowactionForm.enumtype"
                              }
                            }),
                            _vm._v(" "),
                            _vm.workflowactionForm.errors.has("enumtype")
                              ? _c("span", {
                                  staticClass:
