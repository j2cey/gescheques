...
class CreateWorkflowObjectFieldTypesTable extends Migration
{
    use BaseMigrationTrait;

    public $table_name = 'workflow_object_field_types';
    public $table_comment = 'types de champs d objet d un workflow';
