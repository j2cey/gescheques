...
class CreateActionsRequiredWithTable extends Migration
{
    use BaseMigrationTrait;

    public $table_name = 'actions_required_with';
    public $table_comment = 'liste des actions dont la présence rend l action obligatoire.';
    ...
    public function up()
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->foreignId('main_workflow_action_id')->nullable()
                ->comment('référence de l action pricipale')
