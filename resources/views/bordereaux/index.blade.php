        ...
        <div class="container">
            ...
            <div class="tw-bg-white tw-shadow-md tw-rounded tw-px-3 md:tw-px-8 tw-pt-3 md:tw-pt-6 tw-pb-3 md:tw-pb-8 tw-mb-4">
                ...
                <div class="tw-mb-4">
                    ...
                    <h2 class="tw-text-blue-600 tw-text-lg tw-font-bold tw-mb-3 tw-border-b tw-border-gray-400 tw-pb-2">Bordereaux</h2>

                    <!-- SEARCH FORM -->

                    <search-form
                        group="bordereau-search"
                        url="{{ route('bordereaus.fetch') }}"
                        :params="{
                            search: '',
                    ...
                    <search-results group="bordereau-search" v-slot="{ total, records }">
                            ...
                            <template v-if="records.length">
                                ...
                                <table class="table-auto">
                                    ...
                                    >
                                        ...
                                        <td class="tw-px-4 tw-py-2">@{{ record.bordereau_type_titre }}</td>
                    ...
                    <search-pagination group="bordereau-search" :always-show="true"></search-pagination>
