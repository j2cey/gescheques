<template>
    <section>
        ...
        <b-table
            ...
            <template v-for="column in columns">
                <b-table-column :key="column.id" v-bind="column">
                    ...
                    <template v-slot="props">
                        <span v-if="column.date" class="tag is-success">
            ...
            <b-table-column field="user.first_name" label="First Name" sortable v-slot="props" :searchable="true">
                {{ props.row.user.first_name }}
            </b-table-column>

            <b-table-column field="user.last_name" label="Last Name" sortable v-slot="props" :searchable="true">
