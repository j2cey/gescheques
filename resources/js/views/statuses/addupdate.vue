        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-sm" id="statusModalLabel" v-if="editing">Edit Status</h5>
                    <h5 class="modal-title text-sm" id="statusModalLabel" v-else>Create New Status</h5>
