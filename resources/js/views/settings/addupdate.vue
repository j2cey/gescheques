        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-sm" id="settingModalLabel" v-if="editing">Edit Setting</h5>
                    <h5 class="modal-title text-sm" id="settingModalLabel" v-else>Create New Setting</h5>
