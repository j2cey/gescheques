...
trait HasImportFileResult
{
    ...
    public function importfileresults()
    {
        ...
        return $this->belongsToMany(FileImportResult::class, 'model_has_import_file_result', 'model_id', 'import_file_result_id')
    ...
    private function createNewResult($importing = false) {
        ...
        $new_result = FileImportResult::create($default_values);
